...
exports.getStudentConductCharacterAssessmentPlan = getStudentConductCharacterAssessmentPlan;
const similaritySearch_1 = require("../utils/similaritySearch");
const prompts_1 = require("../templates/prompts");
async function getStudentConductCharacterAssessmentPlan(req, res) {
    try {
        const body = req.body;
