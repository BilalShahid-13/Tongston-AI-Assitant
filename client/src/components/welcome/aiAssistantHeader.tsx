    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="space-y-8">
        <div className="text-center">
          <h3 className="text-2xl font-bold text-zinc-800 dark:text-neutral-300 mb-2">Comprehensive Educational Tools</h3>
          <p className="text-zinc-600 dark:text-neutral-400">
            Everything you need to deliver exceptional entrepreneurial education experiences
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-[oklch(0.828_0.189_84.429)]/10 to-[oklch(0.769_0.188_70.08)]/10 rounded-xl shadow-lg p-6 border border-[oklch(0.828_0.189_84.429)]/20">
          <div className="text-center mb-6">
            <h3 className="text-xl font-bold dark:text-white/80 text-zinc-800 mb-2">Resource Library & Tools</h3>
            <p className="text-zinc-600 dark:text-white/80">Access comprehensive educational resources and management tools</p>
          </div>
