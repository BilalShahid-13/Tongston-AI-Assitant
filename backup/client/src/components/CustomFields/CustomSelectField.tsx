...
export default function CustomSelectField<T extends Record<string, any>>({ form, name, isRequired = false,
  fieldName, placeholder = "Select a Location", list, className }: IFormSchema<T>) {
  return (
    <>
      <FormField
        name={name}
